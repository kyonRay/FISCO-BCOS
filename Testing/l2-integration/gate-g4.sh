...
# events to L2 — all of which the A8 devnet (Testing/l2-devnet) provides. None
...
set -euo pipefail
# shellcheck source=Testing/l2-integration/lib.sh
...
L1_BRIDGE_TOOLING="${L1_BRIDGE_TOOLING:-${REPO_ROOT}/Testing/l2-devnet/l1-bridge/deploy.json}"
