...
/// The 13 FISCO-private stateful precompiles hidden when running in L2 mode.
...
static_assert(kL2DisabledSet.size() == 13, "kL2DisabledSet must hold exactly 13 entries");
