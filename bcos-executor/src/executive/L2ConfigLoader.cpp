 ...
 * on the concrete EVM StaticCaller. The production instantiation — wiring the
 * real TransactionExecutive-backed static caller into the Scheduler's per-block
 * hook — lands with the A4 OpStackInitializer workflow, not this PR. PR-4 only
